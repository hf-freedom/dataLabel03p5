...
public class UserController {
    ...
    @PostMapping("/update")
    public Result<String> update(@RequestBody User user, HttpSession session, HttpServletRequest request) {
        return userLogicService.update(user, session, request);
    }

    @DeleteMapping("/{id}")
    public Result<String> delete(@PathVariable Long id, HttpServletRequest request) {
        return userLogicService.deleteById(id, request);
    }

    @PostMapping("/bindRole")
    public Result<String> bindRole(@RequestParam Long userId, @RequestParam Long roleId, HttpServletRequest request) {
        return userLogicService.bindRole(userId, roleId, request);
    }

    @PostMapping("/bindOrg")
    public Result<String> bindOrganization(@RequestParam Long userId, @RequestParam Long orgId, HttpServletRequest request) {
